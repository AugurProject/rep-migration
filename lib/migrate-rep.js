...
const checkRepBalance = require("./get-all-rep-addresses").checkRepBalance;
...
function migrateRepChunk(rpc, repAddressChunk, repContractAddress, senderAddress, onSent, callback) {
  augur.rpc.transact({
    ...
    console.error("migrateRepChunk failed", err, repAddressChunk, senderAddress, repContractAddress);
    callback(null);
  });
}
