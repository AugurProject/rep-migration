...
module.exports.REP_CONTRACT_ADDRESS = ((require("../build/contracts/RepToken").networks || {})[process.env.EXPECTED_NETWORK_ID] || {}).address; // rinkeby
...
module.exports.LEGACY_REP_CONTRACT_ADDRESS = "0x4edf8d2580e87edbf8be3b0dc05acb1bf458a130"; // ropsten
module.exports.LEGACY_REP_CONTRACT_UPLOAD_BLOCK = 1367791; // ropsten
module.exports.LEGACY_REP_FREEZE_BLOCK = 1370588; // ropsten
