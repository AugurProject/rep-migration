...
module.exports.REP_ALLOWANCE_OWNERS_FILE = path.join(__dirname, "..", "data", "all-rep-allowance-owners-" + process.env.EXPECTED_NETWORK_ID + ".txt");
module.exports.REP_ALLOWANCE_SPENDERS_FILE = path.join(__dirname, "..", "data", "all-rep-allowance-spenders-" + process.env.EXPECTED_NETWORK_ID + ".txt");
