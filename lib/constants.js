...
module.exports.REP_CONTRACT_ADDRESS = ((require("../build/contracts/RepToken").networks || {})[networkID] || {}).address; // rinkeby
...
switch (networkID) {
  case "1": // mainnet
    ...
    break;
  case "3": // ropsten
    module.exports.LEGACY_REP_CONTRACT_ADDRESS = "0x7f28321c01499ca33ab3bebde0d45f9b22b6c402"; // ropsten
    module.exports.LEGACY_REP_CONTRACT_UPLOAD_BLOCK = 1371481; // ropsten
    break;
  case "4": // rinkeby
    ...
    break;
  default:
    throw new Error("Invalid or unset EXPECTED_NETWORK_ID environment variable");
}
